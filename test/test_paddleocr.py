...
from app.auxiliary.paddle_ocr.rapid_ocr_api import RapidOCR
...
if __name__ == '__main__':
    ...
    image_path = "../data/test_imgs/general.jpg"
    ...
    if result:
        visualize(image_path, result, font_path='../app/instances/custom.ttf')
